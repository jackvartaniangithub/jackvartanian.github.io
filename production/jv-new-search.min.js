    ...
    try {
        ...
        let Search = {
            init: () => {
                ...
                Search.hideActiveFilter();
                Search.arrangeOrderBy();
                Search.startMobile();

                // filterBoxFunctions
                Search.start();
                Search.appendMostraFiltros();
                Search.appendRemoveBtnTodosFiltros();
                Search.removeMarcaPaisFromVinhos();
                Search.showBox();
                Search.initOrderBox();

                // shelfAdegaFunctions
                Search.startFlags();
                Search.createObservers();
                Search.mobileChanges();
                Search.starterKitFunctions();
                Search.unityFirst();

                // generalFunctions
                Search.arrangePagination();
                Search.arrangeOrderByScore();
                Search.arrangeSlick();
                Search.scriptPopUpAdega();

                // other
                Search.otherFunctions();
                Search.applyPromotionWeekCustomer();
            },
            windowOnload: () => {
            ...
            arrangeOrderBy: () => {
                ...
                try {
                    ...
                    console.log('error arrangeOrderBy function')
                }
            },
            // filterBoxFunctions
            start: () => {
            ...
            appendMostraFiltros: () => {
                ...
                for (i = 0; i < filtrado.length; i++) {
                    ...
                    try {
                        ...
                        nomeFiltro = ""
                        console.log('error appendMostraFiltros function');
                    }
            ...
            appendRemoveBtnTodosFiltros: () => {
                ...
                try {
                    ...
                    console.log('error appendRemoveBtnTodosFiltros function');
                }
            ...
            startFlags: () => {
                ...
                for (i = 0; i < flagEl.length; i++) {
                    shelfAdegaFunctions.insertFlag(flagEl, i);
                }
            },
            createObservers: () => {
            ...
            arrangePagination: () => {
                ...
                window.addEventListener('hashchange', function() {
                    setTimeout(function() {
                        ...
                        console.log('hash '.concat(hashNum));
                        console.log('pg '.concat(curPg));
                        if (curPg != hashNum) {
                            //$('.main').hide();
            ...
            otherFunctions: () => {
                $.getJSON("https://jackvartanian.vteximg.com.br/arquivos/000-JML-jsonColecoes.js", function(colecaoJson) {
                    structuresFunctions.collecttionConstructor(colecaoJson);
                });
                ...
                if (window.location.href.includes('brand=true')) {
                    $.getJSON("https://jackvartanian.vteximg.com.br/arquivos/000-JML-jsonVinicolas.js", function(vinicolasJson) {
                        structuresFunctions.wineryConstructor(vinicolasJson);
                    });
                    $('.ColecaoDescTop').hide();
                    $('.ColecaoTitulo').hide();
                } else {
            ...
            applyPromotionWeekCustomer: () => {
                ...
                try {
                    if ($('ul li.filtro-ativo')[0].innerText == 'Semana do consumidor') {
